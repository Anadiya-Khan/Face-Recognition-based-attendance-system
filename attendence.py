...
# 4th image
        ...
        title=Label(bg_img,text="Attendance Management System",font=("times new roman",18,"bold"),fg="white",bg="darkblue")
...
# id
        std_id=Label(left_inside_frame,text="ID : ",font=("times new roman",13,"bold"),bg="white")
        std_id.grid(row=0,column=0,padx=20,pady=10,sticky=W)
        std_id_entry=ttk.Entry(left_inside_frame,textvariable=self.var_atten_id,width=20,font=("times new roman",13,"bold"))
        std_id_entry.grid(row=0,column=1,padx=20,pady=10,sticky=W)

# roll no
        std_roll=Label(left_inside_frame,text="Roll no : ",bg="white",font=("times new roman",13,"bold"))
        std_roll.grid(row=0,column=2,padx=20,pady=10,sticky=W)
        std_roll_entry=ttk.Entry(left_inside_frame,textvariable=self.var_atten_roll,font=("times new roman",13,"bold"),width=20)
        std_roll_entry.grid(row=0,column=3,padx=20,pady=10,sticky=W)

#name

        std_name=Label(left_inside_frame,text="Name : ",bg="white",font=("times new roman",13,"bold"))
        std_name.grid(row=1,column=0,padx=20,pady=10,sticky=W)
        std_name_entry=ttk.Entry(left_inside_frame,textvariable=self.var_atten_name,font=("times new roman",13,"bold"),width=20)
        std_name_entry.grid(row=1,column=1,padx=20,pady=10,sticky=W)

#Department        
        std_dep=Label(left_inside_frame,text="Department : ",bg="white",font=("times new roman",13,"bold"))
        std_dep.grid(row=1,column=2,padx=20,pady=10,sticky=W)
        std_dep_entry=ttk.Entry(left_inside_frame,textvariable=self.var_atten_dep,font=("times new roman",13,"bold"),width=20)
        std_dep_entry.grid(row=1,column=3,padx=20,pady=10,sticky=W)

 #time       
        std_time=Label(left_inside_frame,text="Time : ",bg="white",font=("times new roman",13,"bold"))
        std_time.grid(row=2,column=0,padx=15,pady=10,sticky=W)
        std_time_entry=ttk.Entry(left_inside_frame,textvariable=self.var_atten_time,font=("times new roman",13,"bold"),width=20)
        std_time_entry.grid(row=2,column=1,padx=15,pady=10,sticky=W)

 #date       
        std_date=Label(left_inside_frame,text="Date : ",bg="white",font=("times new roman",13,"bold"))
        std_date.grid(row=2,column=2,padx=15,pady=10,sticky=W)
        std_date_entry=ttk.Entry(left_inside_frame,textvariable=self.var_atten_date,font=("times new roman",13,"bold"),width=20)
        std_date_entry.grid(row=2,column=3,padx=15,pady=10,sticky=W)


#status        
        std_status=Label(left_inside_frame,text="Status: ",bg="white",font=("times new roman",13,"bold"))
        std_status.grid(row=3,column=0,padx=15,pady=10,sticky=W)
        std_combo=ttk.Combobox(left_inside_frame,textvariable=self.var_atten_status,font=("times new roman",13,"bold"),width=15,state="readonly")
        std_combo["values"]=("Select","Present","Absent")
        std_combo.current(0)
        std_combo.grid(row=3,column=1,padx=15,pady=10,sticky=W)
        ...
        delete_btn=Button(btn_frame,text="Delete",command=self.delete,width=17,font=("times new roman",13,"bold"),bg="skyblue",fg="white")
        ...
        self.student_table=ttk.Treeview(table_frame,columns=("id","roll","name","department","time","date","attendence"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("attendence",text="Attendence")
        ...
        self.student_table.column("attendence",width=100)
...
#export CSV
    ...
    def get_cursor(self, event=""):
        ...
        if len(rows) < 7:  # Ensure there are enough elements
    ...
    # Get the selected row
        ...
        # Get the row data
        item_data = self.student_table.item(selected_item[0])["values"]
        if not item_data:
